...
let jm1 = new JugadoraMahou({
  name: "Patri Camacho - Nov 2022",
  month: "NOVIEMBRE",
  imgLink: "./gen_resources/general images/mahou/patri_camacho.jpg",
});
let jm2 = new JugadoraMahou({
  name: "Noemí Andrés - Dic 2022",
  month: "DICIEMBRE",
  imgLink: "./gen_resources/general images/mahou/noemi_andres.jpg",
});
let jm3 = new JugadoraMahou({
  name: "Cris Menéndez - Ene 2023",
  month: "ENERO",
  imgLink: "./gen_resources/general images/mahou/cris_menendez.jpg",
});
let jm4 = new JugadoraMahou({
  name: "Rosa Torres - Feb 2023",
  month: "FEBRERO",
  imgLink: "./gen_resources/general images/mahou/rosa_torres.jpg",
});
let jm5 = new JugadoraMahou({
  name: "Arantxa de la Chica - Mar 2023",
  month: "MARZO",
...
for (let jugadora of arrJugadorasMahou) {
  if (jugadora == arrJugadorasMahou[0]) {
    mahouMainImg.innerHTML += `<img title="${jugadora.title}" src="${
      jugadora.imgLink
...
let ep1 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #1 | Noelia Llamas y Nuria Díaz",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://youtu.be/Pjo7oMxt0z0?t=4244"
);
let ep2 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #2 | Cris Menéndez e Irene González",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://youtu.be/8cKPmhVXRfw?t=4880"
);
let ep3 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #3 | Alba Masa",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://www.youtube.com/live/TQEcYiiyh7c?feature=share&t=5249"
);
let ep4 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #4 | Arantxa y Raquel Guardado",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://www.youtube.com/live/_IOZnSWAAZM?feature=share&t=5415"
);
let ep5 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #5 | Rosa Torres e Iratxe Rodríguez",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://www.youtube.com/live/fWi-vovvN7c?feature=share&t=4562"
);
let ep6 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #6 | Manuela Alfayate",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://www.youtube.com/live/S7mw2GlnGu8?feature=share&t=5516"
);
let ep7 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #7 | Gabriela de la Villa",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://www.youtube.com/live/70MoHl7iGFs?feature=share&t=5827"
);
let ep8 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #8 | Claudia Domínguez",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://youtu.be/NIC4C8th3SE?t=4430"
);
let ep9 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #9 | Sara Yagüe",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https:/https://www.youtube.com/live/mNlmfJrzERs?feature=share&t=6017"
);
let ep10 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #10 | Lucía Fernández",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://www.youtube.com/live/To3hy6NKU5g?feature=share&t=5162"
);
let ep11 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #11 | Noemí Andrés y Daniela Sanchís",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://www.youtube.com/live/GaWPCAhUCVs?feature=share&t=4838"
);
let ep12 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #12 | Patri Camacho y Andrea Ovejero",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
  "https://www.youtube.com/live/ItEcAS0saOw?feature=share&t=5194"
);
let ep13 = new Episode(
  "LUNES NOCHE FÚTBOL DE MADRID #13 | Andrea García e Iria Moya",
  "/gen_resources/general images/lunes_noche_futbol_blue.jpg",
